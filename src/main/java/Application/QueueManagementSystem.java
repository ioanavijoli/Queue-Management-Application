...
public class QueueManagementSystem extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        QueueManagementSystem.jumpToView("queueManagementSystem.fxml",756,406);
        stage.show();
    }
    ...
    public static void jumpToView(String view, int xSize, int ySize){
        try {
            URL url = QueueManagementSystem.class.getResource(view);
